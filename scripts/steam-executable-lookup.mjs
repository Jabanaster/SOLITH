/**
 * Known Steam AppID → primary Windows executable mappings for catalog seed enrichment.
 * Extend as titles are verified offline; synthetic AppIDs are not listed here.
 */
export const STEAM_EXECUTABLE_LOOKUP = new Map([
...
export function executablesForSteamAppId(steamAppId) {
