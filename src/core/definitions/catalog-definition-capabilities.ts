/**
 * Browser-safe schema.v1 capability lane helpers.
 *
 * Keep this module free of Node/DB imports — the Vite renderer reaches it via
 * TrainerLibraryPage and dual-read save controls. Store-backed loaders live in
